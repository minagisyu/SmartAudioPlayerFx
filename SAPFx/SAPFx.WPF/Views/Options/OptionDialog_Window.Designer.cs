namespace SmartAudioPlayerFx.Views.Options
{
	partial class OptionDialog_Window
	{
		...
		private void InitializeComponent()
		{
			...
			this.active_preview = new SmartAudioPlayerFx.Views.Options.DoubleBufferedControl();
			this.activeOpacity = new System.Windows.Forms.TrackBar();
			this.groupBox2 = new System.Windows.Forms.GroupBox();
			this.deactive_preview = new SmartAudioPlayerFx.Views.Options.DoubleBufferedControl();
