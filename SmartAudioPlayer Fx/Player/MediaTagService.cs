...
namespace SmartAudioPlayerFx.Player
{
	...
	static class MediaTagService
	{
		...
		sealed class MediaTagInfo_Mp3infp : MediaTagInfo
		{
			...
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call static ctor");
				try
				{
					var version = Mp3infp.GetVer();
					disabled = (version < 0x253);
					LogService.AddDebugLog("MediaTagInfo_Mp3infp", " - mp3infp version: {0}", version);
				}
				catch (Exception)
				{
					LogService.AddDebugLog("MediaTagInfo_Mp3infp", " - GetVer() call error");
					disabled = true;
				}
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", " - tagservice_is_disable={0}", disabled);
			}
			...
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call ctor: filepath={0}", filepath);
				FilePath = filepath;
				...
				lock (sync)
				{
					...
					if (Mp3infp.Load(IntPtr.Zero, FilePath) == 0)
					{
						switch (Mp3infp.GetFileType())
						{
							...
							default:
								IsTagLoaded = false;
								LogService.AddDebugLog("MediaTagInfo_Mp3infp", " - Mp3infp.GetFileType() == unknown");
								break;
						}
					...
					{
						IsTagLoaded = false;
						LogService.AddDebugLog("MediaTagInfo_Mp3infp", " - Mp3infp.Load() failed.");
					}
				}
			}
			...
			void CollectByMP3()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByMP3");
				var tagtype = Mp3infp.Mp3_GetTagType();
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", " - Mp3infp.Mp3_GetTagType() == {0}", tagtype);
			...
			void CollectByWav()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByWav");
			...
			void CollectByAvi()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByAvi");
				Mp3infp.GetValue("INAM", out Title);
				Mp3infp.GetValue("IART", out Artist);
				Mp3infp.GetValue("ICMT", out Comment);
			}
			...
			void CollectByVQF()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByVQF");
				Mp3infp.GetValue("INAM", out Title);
				Mp3infp.GetValue("IART", out Artist);
				Mp3infp.GetValue("ICMT", out Comment);
			}
			...
			void CollectByWMA()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByWMA");
				Mp3infp.GetValue("INAM", out Title);
				Mp3infp.GetValue("IART", out Artist);
				Mp3infp.GetValue("IPRD", out Album);
				Mp3infp.GetValue("ICMT", out Comment);
			...
			void CollectByOGG()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByOGG");
				Mp3infp.GetValue("INAM", out Title);
				Mp3infp.GetValue("IART", out Artist);
				Mp3infp.GetValue("IPRD", out Album);
				Mp3infp.GetValue("ICMT", out Comment);
			...
			void CollectByAPE()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByAPE");
				Mp3infp.GetValue("INAM", out Title);
				Mp3infp.GetValue("IART", out Artist);
				Mp3infp.GetValue("IPRD", out Album);
				Mp3infp.GetValue("ICMT", out Comment);
			...
			void CollectByMpeg4()
			{
				LogService.AddDebugLog("MediaTagInfo_Mp3infp", "Call CollectByMpeg4");
				Mp3infp.GetValue("INAM", out Title);
				Mp3infp.GetValue("IART", out Artist);
				Mp3infp.GetValue("IPRD", out Album);
				Mp3infp.GetValue("ICMT", out Comment);
			...
			internal static class Mp3infp
			{
				...
				public static extern bool GetValue(string szValueName, out string buf);
