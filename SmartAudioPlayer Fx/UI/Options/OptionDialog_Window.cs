...
namespace SmartAudioPlayerFx.UI.Options
{
	sealed partial class OptionDialog_Window : OptionPage
	{
		...
		{
			activeOpacity.Value = InactiveOpacity.Limit(activeOpacity.Minimum, activeOpacity.Maximum);
			deactiveOpacity.Value = DeactiveOpacity.Limit(deactiveOpacity.Minimum, deactiveOpacity.Maximum);
