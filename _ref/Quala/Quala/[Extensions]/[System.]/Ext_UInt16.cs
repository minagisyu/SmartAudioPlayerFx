...
namespace Quala
{
	...
	partial class Extension
	{
		...
		/// 値の半精度上位値を取得します
		/// </summary>
		public static byte HighValue(this TType value)
		{
		...
		/// 値の半精度下位値を取得します
		/// </summary>
		public static byte LowValue(this TType value)
		{
		...
		/// <returns></returns>
		public static uint MakeValue(this TType value, TType high)
		{
			return (uint)(((high << 16) & 0xffff0000) | (ushort)value);
		}
