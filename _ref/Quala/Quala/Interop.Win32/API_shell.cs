...
namespace Quala.Interop.Win32
{
	partial class API
	{
		...
		[DllImport(Shell32)]
		private static extern int SHCreateItemFromParsingName(string pszPath, IBindCtx pbc, ref Guid riid, out IShellItem ppsi);
		...
		/// <returns></returns>
		public static IShellItem GetShellItemFromPath(string path)
		{
