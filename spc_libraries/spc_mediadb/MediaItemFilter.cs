...
namespace SmartAudioPlayer
{
	...
	public sealed class MediaItemFilter : IDisposable
	{
		...
		public MediaItemFilter(Preferences preferences)
		{
			Reset();
	...
	public static class MediaItemFilterManagerExtensions
	{
		public static IObservable<string> PropertyChangedAsObservable(this MediaItemFilter manager)
		{
